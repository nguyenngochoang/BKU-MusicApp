            ...
            mDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if(dataSnapshot.hasChild(nameV)){
                        alert = new Alert(1,getString(R.string.error),SignUpActivity.this,"","");
                        ...
                        try{
                            ...
                            alert = new Alert(2,getString(R.string.registerOK),SignUpActivity.this,"nameV",name.getText().toString());
                        }
